...
-define(EASTON_COMMAND_DOC_COUNT, 12).
-define(EASTON_COMMAND_QUERY, 13).
-define(EASTON_COMMAND_QUERY_TP, 14).
-define(EASTON_COMMAND_NEAREST, 15).
-define(EASTON_COMMAND_NEAREST_TP, 16).
